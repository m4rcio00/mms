...
function tooltipmms(){
	jQuery('.tooltip-contato').tooltipster({
				...
				delay:100,
				content: 
				jQuery('<div class="fale-conosco"><div class="dropdown dropTelevendas"><i class="ic icBigFone"></i><div class="laranja">Atendimento</div><p class="fale-msg">Tire suas dúvidas sobre produtos, preços ou pedidos</p><div class="borderSection"><div class="titleTele"><i class="icemail"></i> Envie sua dúvida para nossa equipe de suporte</div><span class="colLabelTele">E-mail</span> <span class="colInfoTele">contato@mmstoree.com.br</span><span class="colLabelTele">Skype</span> <span class="colInfoTele">marciosanttanna</span></div><div class="borderSection"><div class="titleTele"><i class="ichora"></i> Horário de Atendimento</div><span class="colLabelTele">Segunda a Sexta</span> <span class="colInfoTele">8h00 às 20h00</span><span class="colLabelTele">Sábados</span> <span class="colInfoTele">8h00 às 14h00</span></div><div class="borderSection"><div class="titleTele"><i class="ic icmoney"></i> Custo da Chamada</div><span class="colLabelTele">11-45576619</span> <span class="colInfoTele">Custo da ligação + impostos <br> <span class="small">(de acordo com operadora e Estado)</span></span><span class="colLabelTele">11-964476492</span> <span class="colInfoTele">Custo da ligação + impostos </span></div></div></div>'), 
	});			
}
